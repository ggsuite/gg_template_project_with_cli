...
void main() {
  ...
  group('.vscode/launch.json', () {
    test('pathes in launch.json', () {
      ...
      // Ensure there is a configuration for executing bin/gg_template_project_with_cli.dart
      final configurations =
          parsedLaunchJson['configurations'] as List<dynamic>;

      final ggTemplateProjectWithCli = configurations.firstWhere(
        (dynamic configuration) =>
            configuration['name'].toString() ==
            'gg_template_project_with_cli.dart',
      );
      ...
      expect(
        ggTemplateProjectWithCli['name'],
        'gg_template_project_with_cli.dart',
      );
      expect(ggTemplateProjectWithCli['type'], 'dart');
      expect(ggTemplateProjectWithCli['request'], 'launch');
